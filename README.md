...
**IMPORTANT NOTE**: _The instructions below can be applied almost verbatim to generate the results in Section 5.2. The only difference being the scripts to be used, which are located in the `BiotBrinkman3DConvergenceTests` folder_
